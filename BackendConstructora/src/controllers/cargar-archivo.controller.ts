  ...
  @post('/CargarImagenCliente', {
    responses: {
      200: {
        ...
        description: 'Función de carga de la imagen de los clientes.',
      },
    },
  })
  async CargarImagenDelCliente(
  ...
  @post('/CargarImagenProyecto', {
    responses: {
      200: {
        ...
        description: 'Función de carga de la imagen de los proyectos.',
      },
    },
  })
  ...
  @post('/CargarDocumentoCliente', {
    responses: {
      200: {
        ...
        description: 'Función de carga de documentos del cliente.',
      },
    },
  })
  async DocumentosCliente(
    @inject(RestBindings.Http.RESPONSE) response: Response,
    @requestBody.file() request: Request,
  ): Promise<object | false> {
    const rutaDocumentoCliente = path.join(__dirname, llaves.carpetaDocumentoCliente);
